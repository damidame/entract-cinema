...
import com.cinema.entract.app.ext.isToday
import com.cinema.entract.app.ext.longFormatToUi
import com.cinema.entract.app.ext.toUtcEpochMilliSecond
import com.cinema.entract.app.ext.toUtcLocalDate
        ...
        onEvents(cinemaViewModel) { event ->
            when (val data = event.take()) {
                is CinemaEvent.Promotional ->
                    requireActivity().start<PromotionalActivity> {
